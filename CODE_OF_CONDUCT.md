...
Millrace Editor is a small open-source project and we want it to stay a place people enjoy contributing to.
...
- **Stay on topic.** Issues, PRs, and discussions are about Millrace Editor. Take off-topic conversations elsewhere.
...
If you see a violation — or experience one — email **conduct@millrace.dev** with subject `[Millrace Editor conduct]`. Include links and context.
