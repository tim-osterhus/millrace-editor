...
const STORE_PATH = "millrace-editor-settings.json";
...
// window can listen.
const PREFS_CHANGED_EVENT = "millrace-editor://prefs-changed";
...
const KEYS_CHANGED_EVENT = "millrace-editor://ai-keys-changed";
